      ...
      >
        ...
        <section>
          ...
          <Typography variant="body1">
            ...
            <br />
            <br />
            Hi! I'm Danielle, a service dog handler and software developer. This
            app was created to solve a personal problem - I couldn't always
            reliabily remember which restaurants I'd visited in town were good
            choices and which I should avoid going back to. What was the space
            like? How were the staff?
            <br />
            <br />
            ...
            the restaurant's website and social media, and sometimes even having
            to call to find out what I needed to plan my visit.
            <br />
            <br />
            And you can't always tell from those other sources if the floor is
            dirty, sticky, or contains hazards like glass. I wanted to create a
            tool for people like myself to capture these important pieces of
            ...
            places you might be thinking of visiting and see if anyone's left a
            positive review.
            <br />
        ...
        <section>
          <Typography variant="h2" fontSize="h5.fontSize" sx={{ mb: 2, mt: 4 }}>
            How to Use This Website
          </Typography>
          <Typography variant="h3" fontSize="h6.fontSize" sx={{ mb: 2, mt: 4 }}>
            - View others' entries
          </Typography>
          <List component="ol">
            <ListItem>
              1. Use the "My Location" button (lower left of map) to center the
              map on your town
            </ListItem>
          ...
          <List component="ol">
            ...
            <ListItem>
              4. Easily filter existing places to see just your entries or even
              just your favorites
            </ListItem>
          </List>
        </section>
